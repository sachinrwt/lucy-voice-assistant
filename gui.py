...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bg.setText("")
        self.bg.setPixmap(QtGui.QPixmap("Lucy/src/Black_Template.jpg"))
        ...
        self.sm.setText("")
        self.sm.setPixmap(QtGui.QPixmap("Lucy/src/__1.gif"))
        ...
        self.middle.setText("")
        self.middle.setPixmap(QtGui.QPixmap("Lucy/src/Jarvis_Gui (1).gif"))
        ...
        self.earth.setText("")
        self.earth.setPixmap(QtGui.QPixmap("Lucy/src/Earth.gif"))
        ...
        self.percent.setPixmap(QtGui.QPixmap("Lucy/src/dribbble.gif"))
        ...
        self.code.setText("")
        self.code.setPixmap(QtGui.QPixmap("Lucy/src/200.gif"))
        ...
        self.loadpic.setPixmap(QtGui.QPixmap("Lucy/src/0baf79ba59be86610edc1f810a79f2b7.gif"))
        ...
        self.loadbox.setPixmap(QtGui.QPixmap("Lucy/src/wd.jpg"))
        ...
        self.date.setText("")
        self.date.setPixmap(QtGui.QPixmap("Lucy/src/gggf.jpg"))
        ...
        self.day.setText("")
        self.day.setPixmap(QtGui.QPixmap("Lucy/src/gggf.jpg"))
        ...
        self.time.setText("")
        self.time.setPixmap(QtGui.QPixmap("Lucy/src/gggf.jpg"))
        ...
        self.initialize.setPixmap(QtGui.QPixmap("Lucy/src/initial.gif"))
        ...
        self.temp.setText("")
        self.temp.setPixmap(QtGui.QPixmap("Lucy/src/gggf.jpg"))
        ...
        self.region.setText("")
        self.region.setPixmap(QtGui.QPixmap("Lucy/src/gggf.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Lucy"))
        ...
        r = Lucy.wolfram("Temperature of visakhapatnam")
