...
client = wolframalpha.Client("5J6QEG-YQ2J562KQG") #Enter your API key of wolframalpha
...
def wolfram(query):
    api_key = "5J6QEG-YQ2J562KQG" #Enter your API key of wolframalpha
